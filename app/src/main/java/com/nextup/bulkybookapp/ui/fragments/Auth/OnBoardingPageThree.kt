...
import com.nextup.bulkybookapp.databinding.FragmentOnBoardingPageThreeBinding
...
class OnBoardingPageThree : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentOnBoardingPageThreeBinding.inflate(inflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val parent = requireActivity() as OnBoardingActivity
        parent.getNextButton().text = "Done"
